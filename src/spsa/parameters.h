...
#define TUNABLE_LIST(TUNABLE)                                       \
    ...
    TUNABLE(movePickerHistoryWeight, int16_t, 1000, 100, 2000, 50)  \
    TUNABLE(captureHistoryMaxBonus, int16_t, 150, 0, 400, 20)       \
    TUNABLE(captureHistoryMaxScore, int16_t, 15000, 5000, 20000, 1000)
